...
export const SubagentParams = Type.Object({
	...
	maxDurationMs: Type.Optional(Type.Number({ description: "Wall-clock timeout in milliseconds. Process is killed after this duration. Default: 600000 (10 minutes)." })),
});
